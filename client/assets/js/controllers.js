...
// Log In Controller
App.controller('LoginCtrl', ['$scope', '$localStorage', '$state', 'Auth',
...
App.controller('TransactionsCtrl', ['$scope', '$http',
    function ($scope, $http) {
        $http.get('http://api.moco-moco/tags').then(function(res){
...
//
App.controller('TemplatesCtrl', ['$scope', '$localStorage', '$window',
