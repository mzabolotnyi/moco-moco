...
(function (window, $, undefined) {
    ...
    datepicker.prototype = {
        ...
        _triggerOnSelectByButton: function () {
            if (!this.selectedDates.length) {
                return this.opts.onSelectByButton('', '', this);
            }
            ...
            this.opts.onSelectByButton(formattedDates, dates, this);
        },
        ...
        select: function () {
            ...
            if (this.opts.onSelectByButton) {
                this._triggerOnSelectByButton();
            }
...
;(function () {
    ...
    Datepicker.Navigation.prototype = {
        ...
        _addButtonsIfNeed: function () {
            ...
            if (this.opts.selectButton) {
                this._addButton('select')
            }
