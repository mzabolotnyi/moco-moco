...
class UserSignup extends Model
{
    ...
    protected function createDefaultCategories()
    {
        ...
        $categoriesData = [
            ...
            ['name' => 'Здоровье', 'icon' => 'fa-user-md', 'user_id' => $userId, 'active' => true, 'income' => false, 'expense' => true],
            ['name' => 'Красота и уход', 'icon' => 'fa-bath', 'user_id' => $userId, 'active' => true, 'income' => false, 'expense' => true],
            ['name' => 'Долги, кредиты', 'icon' => 'fa-credit-card', 'user_id' => $userId, 'active' => true, 'income' => true, 'expense' => true],
            ['name' => 'Квартира, коммуналка', 'icon' => 'fa-lightbulb-o', 'user_id' => $userId, 'active' => true, 'income' => false, 'expense' => true],
            ...
            ['name' => 'Отдых и развлечение', 'icon' => 'fa-gamepad', 'user_id' => $userId, 'active' => true, 'income' => false, 'expense' => true],
